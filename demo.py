...
while character_health > 0:
    ...
    if character_health != 100 and item == "Orb":
    ...
    #Start of Journey
    if v == 1: 
        choice = input("If you want to go Cave select [1 for yes/ 0 for no]")
        if choice == "1":
            #Fishing minigame
            print("You have chosen catch an Orb! ")
            chance = random.randint(0,9)
            if chance > 6:
                item = "Orb"
                print("You have catch a Orb!")
            else:
                print("There is no Orb to catch")
        ...
        print("Your character has taken 50pt of damage")
